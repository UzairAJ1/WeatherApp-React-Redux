...
<div className='w-full h-[600px]'>
    <MapContainer style={{ height: 500 }} center={[weatherData.data.coord.lat,weatherData.data.coord.lon]} zoom={7} scrollWheelZoom={false}>
  <TileLayer
    attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
    url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
  />
    <Marker position={[weatherData.data.coord.lat,weatherData.data.coord.lon]} icon={customIcon} >
    <Popup>
